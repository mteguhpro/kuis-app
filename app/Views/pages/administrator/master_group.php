    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="form-popup">
                    ...
                    <div class="form-group">
                        ...
                        <input required type="text" class="form-control" placeholder="Group Name" id="name">
                    </div>
                    <div class="form-group">
                        <label for="code">Code:</label>
                        <input required type="text" class="form-control" placeholder="Group Code" id="code">
                    </div>
                </form>
            </div>
            <div class="modal-footer">
                ...
                <button type="button" id="form-update" class="btn btn-warning">Update</button>
            </div>
        </div>
    </div>
</div>
